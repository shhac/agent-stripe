...
- When adding/changing commands, update `agent-stripe usage`, any relevant domain usage (`subscriptions usage`, `invoices usage`, `payments usage`, `connect usage`), `skills/agent-stripe/SKILL.md`, skill references under `skills/agent-stripe/references/`, README examples when user-facing, and the investigation workflow design doc.
