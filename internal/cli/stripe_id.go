...
var stripeIDKinds = []stripeIDKind{
	...
	{Kind: "setup_intent", Display: "SetupIntent", Prefixes: []string{"seti_"}, GetCommand: "agent-stripe setup-intents get", APIPath: "/v1/setup_intents"},
	{Kind: "checkout_session", Display: "Checkout Session", Prefixes: []string{"cs_"}, GetCommand: "agent-stripe checkout-sessions get", ResolveObject: "checkout.session", APIPath: "/v1/checkout/sessions"},
	{Kind: "early_fraud_warning", Display: "early fraud warning", Prefixes: []string{"issfr_"}, GetCommand: "agent-stripe early-fraud-warnings get", APIPath: "/v1/radar/early_fraud_warnings"},
	{Kind: "balance_transaction", Display: "balance transaction", Prefixes: []string{"txn_"}, GetCommand: "agent-stripe balance-transactions get", APIPath: "/v1/balance_transactions"},
	{Kind: "application_fee", Display: "application fee", Prefixes: []string{"fee_"}, GetCommand: "agent-stripe application-fees get", APIPath: "/v1/application_fees"},
	...
	{Kind: "payment_method", Display: "PaymentMethod", Prefixes: []string{"pm_"}, GetCommand: "agent-stripe payment-methods get", APIPath: "/v1/payment_methods"},
	...
	{Kind: "refund", Display: "refund", Prefixes: []string{"re_"}, GetCommand: "agent-stripe refunds get", InvestigateCommand: "agent-stripe investigate refund-status", APIPath: "/v1/refunds"},
	...
	{Kind: "account", Display: "account", Prefixes: []string{"acct_"}, GetCommand: "agent-stripe accounts get", InvestigateCommand: "agent-stripe investigate outgoing-payment", APIPath: "/v1/accounts"},
